...
const QUESTIONS = [
  ...
  },
  {
    ...
    "correct": [
      "Punkt szeregowania występuje po każdej dyrektywie #pragma omp taskwait",
  ...
  },
  {
    ...
    "wrong": [
      "Są stosowane głównie w systemach jednordzeniowy — nie, obliczenia masowo równoległe wymagają wielu jednostek wykonawczych.",
  ...
  },
  {
    ...
    "correct": [
      "Podział iteracji pętli (Loop Partitioning)",
      "Dynamiczny przydział pracy (Task Pooling)"
    ],
    "wrong": [
  ...
  },
  {
    ...
    "correct": [
      "Oznacza że procesor może dynamicznie zmieniać kolejniść wykonywania instrukcji aby zoptymalizować wydajność"
    ],
    "wrong": [
      "Znaczy że kolejność wykonywania instrukcji zawsze musi być zgodne z kolejnościa w kodzie — Niepoprawne według klucza; ta odpowiedź nie opisuje właściwego mechanizmu ani pojęcia z pytania.",
      "Oznacza że instrukcje w programie są wykonywane zgodnie z piorytetem nadanym przez porgramistę — Niepoprawne według klucza; ta odpowiedź nie opisuje właściwego mechanizmu ani pojęcia z pytania.",
  ...
  },
  {
    ...
    "extra": false,
    "type": "open",
    "question": "Wypisz zależności pojawiające się w kodzie:",
    "correct": [
      "1 → 2, zmienna y, RAW",
      "1 → 3, zmienna y, RAW",
      "2 → 3, zmienna x, RAW",
  ...
  },
  {
    ...
    "extra": false,
    "type": "open",
    "question": "Jakie będą wartości zmiennych a, b i c w dowolnym wątku? treść / kod z pliku Kod: int a = 3; int b = 2; int c = 1;#pragma omp parallel firstprivate(a) num_threads(4){ int b = a * c; #pragma omp barrier #pragma omp atomic c += 2; a += 3; b += 4 #pragma omp barrier}",
    "correct": [
      "a = 6",
      "b = 7",
      "c = 9"
  ...
  },
  {
    ...
    "extra": false,
    "type": "open",
    "question": "Zanalizuj zależności przenoszone w pętli. Wpisz obok typu zależności nazwe tablicy której dotyczy, jeśli nie ma wpisz kreske treść / kod z pliku WAW WAR RAW Kod: for (i = 1; i < N; i++){ A[i] = D[i-1] - C[i-1]; D[i-1] = 2 * D[i+1];}",
    "correct": [
  ...
  },
  {
    ...
    "correct": [
      ...
      "Thread.yield() powoduje, że wątek zwraca posiadane zasoby procesora do planisty, umożliwiając innym wątkom działającym w tej samej aplikacji ich użycie.",
  ...
  },
  {
    ...
    "extra": false,
    "type": "mc",
    "question": "Które dyrektywy OpenMP służą do synchronizacji wątków? treść / kod z pliku Z obrazu widać odpowiedzi: a. #pragma omp barrierb. #pragma omp criticalc. #pragma omp atomicd. #pragma omp distributee. #pragma omp master",
    "correct": [
      "#pragma omp barrier",
      "#pragma omp critical",
      "#pragma omp atomic"
  ...
  },
  {
    ...
    "extra": false,
    "type": "open",
    "question": "Wartości zmiennych po zakończeniu pętli OpenMP. treść / kod z pliku Kod z obrazka: int a = 1, b = 4, c = 5, d = 0, i;#pragma omp parallel for private(b) shared(c) lastprivate(d) num_threads(3)for (i = 0; i < 3; i++) { b += 1; 4 c += b; 7 9 d = omp_get_thread_num(); 2}",
    "correct": [
      "a = 1",
      "b = 4",
      "c = ?",
  ...
  },
  {
    ...
    "extra": false,
    "type": "mc",
    "question": "Co można powiedzieć o sposobie przetwarzania i dostępu do zmiennej id?",
    "correct": [
      "id jest prywatne dla każdego wątku, co oznacza, że każdy wątek ma swoją kopię",
      "Jeśli nie użyto by klauzuli private(id), to id byłoby współdzielone i powodowało błędy",
